...
public class Eleve {
   ...
   // Champs requis par le schéma de synchronisation
   ...
   // --- Getters & Setters Additionnels pour la Synchro ---
   ...
   public int getNombreAbsences() { return 0; }
   ...
   public LieuNaissance getLieuNaissance() { return this.lieuNaissance; }

   // =========================================================================
   //  GETTERS ET SETTERS EXISTANTS
   // =========================================================================

   public String getParent() { return (this.parent != null) ? this.parent.getIdParent() : null; }
   public String getIdParent() { return (this.parent != null) ? this.parent.getIdParent() : null; }
   public String getMatricule() { return this.Matricule; }
   public String getNomParent(){ return (this.parent != null) ? this.parent.getPrenom() : ""; }
   ...
   public String getLieuNaissanceLibelle() { return this.lieuNaissance != null ? this.lieuNaissance.getLibelle() : ""; }
   public Sexe getSexe() { return this.sexe; }
   public void setSexe(Sexe sexeUpdate) { this.sexe = sexeUpdate; }
   ...
   public Nationnalite getNationalite() { return this.nationalite; }
   public void setNationalite(Nationnalite nationalite) { this.nationalite = nationalite; }
   ...
   public String getNationnalite() { return this.nationalite != null ? this.nationalite.getLibelle() : ""; }
   public void setNationnalite(String nationnalite) { setNationalite(nationnalite); }
   public String getPhoto() { return this.photo; }
   public void setPhoto(String photo) { this.photo = photo; }
   public boolean getATerminerPension() { return this.aTerminerPension; }
   public void setaTerminerPension(boolean aTerminerPension) { this.aTerminerPension = aTerminerPension; }
   public Region getRegionOrigine() { return regionOrigine; }
   public void setRegionOrigine(Region regionOrigine) { this.regionOrigine = regionOrigine; }
   ...
   public String getRegionOrigineLibelle() { return this.regionOrigine != null ? this.regionOrigine.getLibelle() : ""; }
   ...
   public Bulletin getBulletin() { return this.bulletinEleve; }
   public Inscription getInscription() { return inscription; }
   public void setInscription(Inscription newInscription) { this.inscription = newInscription; }

   public Collection<DocumentScolaire> getDocumentScolaire() {
      if (documentScolaire == null) documentScolaire = new HashSet<>();
   ...
   public void setDocumentScolaire(Collection<DocumentScolaire> newDocumentScolaire) {
      ...
      for (DocumentScolaire ds : newDocumentScolaire) addDocumentScolaire(ds);
   }

   public void addDocumentScolaire(DocumentScolaire newDocumentScolaire) {
      if (newDocumentScolaire == null) return;
      if (this.documentScolaire == null) this.documentScolaire = new HashSet<>();
      if (!this.documentScolaire.contains(newDocumentScolaire)) this.documentScolaire.add(newDocumentScolaire);
   }

   public void removeDocumentScolaire(DocumentScolaire oldDocumentScolaire) {
      if (oldDocumentScolaire == null) return;
      if (this.documentScolaire != null && this.documentScolaire.contains(oldDocumentScolaire)) this.documentScolaire.remove(oldDocumentScolaire);
   }

   public void removeAllDocumentScolaire() { if (documentScolaire != null) documentScolaire.clear(); }
}